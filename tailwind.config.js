...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: ({
        'profile-pic': "url('/portfolio/img/profile-picture.webp')",
        'office-pic': "url('/portfolio/img/office-picture.webp')",
        'window-picture': "url('/portfolio/img/icons/pictures/bg-picture.webp')",
      ...
      cursor: {
        'default': 'url(/portfolio/img/cursors/default-cursor.cur), auto',
        'pointer': 'url(/portfolio/img/cursors/pointer-cursor.cur), auto',
        'wait': 'url(/portfolio/img/cursors/wait-cursor.cur), auto',
      },
      borderWidth: {
        '3': '3px',
      },
