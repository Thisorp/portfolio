    ...
    <div v-for="(tools, index) in headerTools" :key="index" class="flex items-center h-full min-w-max">
      ...
      <div v-if="tools.type === 'group'" class="flex justify-center items-center">
        ...
        <div v-if="tools.hasBackAndForward" class="flex items-center pl-1">
          ...
          >
            <img src="/portfolio/img/icons/windows-header-tools/right-arrow-green-icon.webp" :alt="$t('common.icon') + ' ' + $t('common.back')" class="w-7 h-7 flex-shrink-0" />
          ...
          <div class="flex items-center mr-1 filter grayscale">
            <img src="/portfolio/img/icons/windows-header-tools/left-arrow-green-icon.webp" :alt="$t('common.icon') + ' ' + $t('common.next')" class="w-7 h-7 flex-shrink-0" />
